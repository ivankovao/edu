...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      carService.add(new Car("Mers",4));
      carService.add(new Car("BMW",750));
      carService.add(new Car("lada",2109));
      carService.add(new Car("Renault",4));
      ...
      System.out.println(userService.findUserByModelAndSeries("lada", 2109));
      context.close();
   }
}
